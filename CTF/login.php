         ...
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px; color:#ffff66" align = "center">
			   ...
			   <?php 
			    ...
			    echo "Welcome Sergeant ". $user. " to this flag hunt!!"; 
			...
			<br><br><br><div style = "color:#ffff66;" ><?php echo "Enter the "; ?><b><a href="accesscode.wav" style = "color:#ffff66;" ><?php echo "code word"; ?></a></b><?php echo "to get access into the bunker!!"; ?></div>
      </div>
